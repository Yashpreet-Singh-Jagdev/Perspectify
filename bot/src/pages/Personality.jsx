  ...
  return (
    <div className='mt-[100px]'>
     ...
     <iframe className='absolute w-full top-0 h-full'
       src="https://cdn.botpress.cloud/webchat/v2.2/shareable.html?configUrl=https://files.bpcontent.cloud/2024/11/10/09/20241110090431-NXGWBS64.json"  // Replace with the actual URL
